...
REPO_SERVICE_PRINCIPAL_ID=$REPO_SERVICE_PRINCIPAL_ID
REPO_SERVICE_PRINCIPAL_PASSWORD=$REPO_SERVICE_PRINCIPAL_PASSWORD
...
HELM_RELEASE_VERSION=$(echo $S1_AGENT_TAG | cut -d "-" -f2)  #23.1.2
